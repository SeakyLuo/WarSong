...
//        boardInfo = GetComponent<BoardInfo>();
//        radius = Setup.radius;
//        scale = Setup.scale;
...
//        {
//            if (obj.GetComponent<CardInfo>().GetLocation() == loc)
//            {
//                if (obj.GetComponent<CardInfo>().GetPieceType() == "General")
//                {
//                    gameOver = true;
...
//        if (x != 0 && z != 0)
//        {
//            locationMark.transform.position = new Vector3(selected.GetComponent<CardInfo>().GetLocation().x + gridScale / 2, 0f, selected.GetComponent<CardInfo>().GetLocation().y + gridScale / 2) * scale;
...
//            selected.GetComponent<CardInfo>().SetLocation(location);            
...
//        switch (obj.GetComponent<CardInfo>().GetPieceType()[0])
//        {
//            case 'G':
//                for (int i = -1; i <= 1; i += 2)
//                {
...
//                break;
//            case 'R':
//                for (int j = (int)z + 1; j < boardInfo.GetBoardHeight(); j++)
//                {
//                    switch (FindAt(x, j))
//                    {
//                        case 'B':
...
//                    break;
//                }
//                for (int i = (int)x + 1; i < boardInfo.GetBoardWidth(); i++)
//                {
//                    switch (FindAt(i, z))
//                    {
//                        case 'B':
...
//                    else
//                    {
//                        for (int jj = j + 1; jj < boardInfo.GetBoardHeight(); jj++)
//                        {
//                            switch (FindAt(x, jj))
//                            {
//                                case 'B':
...
//                    else
//                    {
//                        for (int ii = i + 1; ii < boardInfo.GetBoardWidth(); ii++)
//                        {
//                            switch (FindAt(ii, z))
//                            {
//                                case 'B':
...
//    private bool InPalace(float x, float z) { return boardInfo.GetPalaceDownLeft().x <= x && x <= boardInfo.GetPalaceUpperRight().x && boardInfo.GetPalaceDownLeft().y <= z && z <= boardInfo.GetPalaceUpperRight().y; }

//    private bool InSelfField(float x, float z) { return 0 <= x && x < boardInfo.GetBoardWidth() && 0 <= z && z <= boardInfo.GetSelfField(); }

//    private bool InBoard(float x, float z) { return 0 <= x && x < boardInfo.GetBoardWidth() && 0 <= z && z < boardInfo.GetBoardHeight(); }
